...
- [PowerPoint (will directly download)](accessibility/Web_accessibility_101.pptx){target="_blank"}
- [PDF (opens in a new tab)](accessibility/Web_accessibility_101.pdf){target="_blank"}